...
import checked from "./checarUsuario.js"
...
export async function login(body, btn) {
    try {
        ...
        if (request.ok) {
            popup("Sucesso!", "Login Efetuado com sucesso!", "Aguarde enquanto estamos redicecionando a página.")
            ...
            popup("Erro!", "Falha ao fazer login", `${message}`)
        }
...
export async function register(body, btn) {
    try {
        ...
        if (request.ok) {
            popup("Sucesso!", "Cadastro feito com sucesso!", "Agora você pode acessar os conteúdos utilizando seu usuário e senha na página de login:", "Acessar página de login")

            setTimeout(() => {
                location.replace("../../Paginas/Login/index.html")
            }, 3000)
...
export async function pathInforUser(body) {
    try {
        ...
        if (request.ok) {
            popup("Sucesso!", "Alteração feita com sucesso.")
...
export async function createDepartment(body) {
    try {
        ...
        if (request.ok) {
            popup("Sucesso!", "Departamento criado com sucesso!")
...
export async function editDepartment(body, uuid) {
    try {
        ...
        if (request.ok) {
            popup("Sucesso!", "Alterações feita com sucesso!")
...
export async function deleteDepartment(uuid) {
    try {
        ...
        if (request.ok) {
            popup("Sucesso!", "Departamento Deletado com sucesso!")
...
export async function editUser(body, uuid) {
    try {
        ...
        if (request.ok) {
            popup("Sucesso!", "Alterações feitas com sucesso!")
...
export async function deleteUser(uuid) {
    try {
        ...
        if (request.ok) {
            popup("Sucesso!", "Usuário deletado com sucesso!")
...
export async function ToHireCompany(body) {
    try {
        ...
        if (request.ok) {
            popup("Sucesso!", "Usuário contratado com sucesso!")
...
export async function userShutdown(uuid) {
    try {
        ...
        if (request.ok) {
            popup("Sucesso!", "Usuário desligado com sucesso!")
